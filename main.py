...
nltk.data.path.append(r'C:\Users\yuargy\AppData\Local\nltk_data')
...
texto 
Soy yuargy, Colombiana me gusta viajar, compartir un buen café con personas que aporten a mi vida, me gusta ayudar a las personas y ser de bendicion
Mis compañeros de proyecto son: Pablo y Leidy.
